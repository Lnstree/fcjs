...
u8 get_joypad_state(int n)
{
    ...
    u8 j = 0;
    // j |=  NesWindow::key_a[0]  << 0;
    // j |=  NesWindow::key_b[0]  << 1;
    // j |=  NesWindow::key_select[0]  << 2;
    // j |=  NesWindow::key_start[0]   << 3;  // Start.
    // j |=  NesWindow::key_up[0]      << 4;
    // j |=  NesWindow::key_down[0]    << 5;
    // j |=  NesWindow::key_left[0]    << 6;
    // j |=  NesWindow::key_right[0]    << 7;
//    if (useJoystick[n])
    {/*
